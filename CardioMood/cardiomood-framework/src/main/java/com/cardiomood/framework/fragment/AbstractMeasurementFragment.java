...
public class AbstractMeasurementFragment extends Fragment {

//    private static final String TAG = AbstractMeasurementFragment.class.getSimpleName();
//
...
//                case AbstractTrackingService.RESP_STATUS:
...
//                    }
//                    break;
//                case AbstractTrackingService.MSG_CONNECTION_STATUS_CHANGED:
//                    onConnectionStatusChanged(msg.arg1, msg.arg2, msg.getData().getString("deviceAddress"));
//                    break;
//                case AbstractTrackingService.RESP_INIT_RESULT:
...
//                    }
//                    break;
//                case AbstractTrackingService.RESP_CONNECT_RESULT:
//                    if (msg.arg1 == CardioMonitoringService.RESULT_FAIL) {
//                        resetHRM();
//                        Toast.makeText(getActivity(), "Failed to connect.", Toast.LENGTH_SHORT).show();
//                    }
//                    break;
//                case AbstractTrackingService.RESP_DISCONNECT_RESULT:
//                    if (msg.arg1 == CardioMonitoringService.RESULT_SUCCESS) {
//                        onConnectionStatusChanged(hrmState, LeHRMonitor.INITIAL_STATUS, null);
//                        resetHRM();
//                    }
//                    break;
//                case AbstractTrackingService.MSG_HR_DATA:
//                    onDataReceived(msg);
//                    break;
//                case AbstractTrackingService.RESP_START_SESSION_RESULT:
//                    inProgress = true;
//                    onSessionStarted(msg);
//                    break;
//                case AbstractTrackingService.RESP_END_SESSION_RESULT:
//                    onSessionFinished(msg);
//                    inProgress = false;
//                    break;
//                case AbstractTrackingService.MSG_RECONNECTING:
//                    onReconnecting(msg);
//                    break;
//                case AbstractTrackingService.MSG_BATTERY_LEVEL:
//                    int level = msg.arg1;
//                    onBatteryLevelReceived(level);
//                    break;
//                case AbstractTrackingService.MSG_PROGRESS:
//                    if (msg.arg1 != 0) {
...
//    };
//
//    public AbstractMeasurementFragment() {
...
//        try {
//            Message msg = Message.obtain(null, AbstractTrackingService.MSG_REGISTER_CLIENT);
//            msg.replyTo = mMessenger;
//            mCardioService.send(msg);
//        } catch (RemoteException ex) {
...
//        try {
//            Message msg = Message.obtain(null, AbstractTrackingService.MSG_UNREGISTER_CLIENT);
//            msg.replyTo = mMessenger;
//            mCardioService.send(msg);
//        } catch (RemoteException ex) {
...
//        try {
//            Message msg = Message.obtain(null, AbstractTrackingService.MSG_GET_STATUS);
//            msg.replyTo = mMessenger;
//            mCardioService.send(msg);
//        } catch (RemoteException ex) {
...
//        try {
//            Message msg = Message.obtain(null, AbstractTrackingService.MSG_UPDATE_INFO);
...
//        try {
//            Message msg = Message.obtain(null, AbstractTrackingService.MSG_RESET);
//            msg.replyTo = mMessenger;
//            mCardioService.send(msg);
//        } catch (RemoteException ex) {
...
//    }
//
//    private Task<SessionEntity> validateSession(final long sessionId) {
//        return Task.callInBackground(new Callable<SessionEntity>() {
//            @Override
//            public SessionEntity call() throws Exception {
//                SessionDAO sessionDao = DatabaseHelperFactory.getHelper().getSessionDao();
//                CardioItemDAO itemDao = DatabaseHelperFactory.getHelper().getCardioItemDao();
//                SessionEntity entity = sessionDao.queryForId(sessionId);
//                String[] result = itemDao.queryRaw(
//                        "select sum(rr), count(rr) from cardio_items where session_id=?",
//                        String.valueOf(sessionId)
//                ).getFirstResult();
//                long count = Long.valueOf(result[1]);
//                double duration = Double.valueOf(result[0]);
//                if (count >= 100 || duration > 60*1000) {
//                    sessionDao.refresh(entity);
//                    if (entity.getEndTimestamp() == null) {
//                        entity.setEndTimestamp(entity.getStartTimestamp() + Math.round(duration));
//                        sessionDao.update(entity);
//                    }
//                    return entity;
//                } else {
//                    // delete recording!
//                    DeleteBuilder del = itemDao.deleteBuilder();
//                    del.where().eq("session_id", entity.getId());
//                    del.delete();
//
//                    sessionDao.deleteById(entity.getId());
//                }
//                return null;
//            }
//        });
//    }
//
//    private void openSessionViewActivity(long sessionId) {
//        if (!isDetached()) {
...
//                        @Override
//                        public Object then(Task<SessionEntity> task) throws Exception {
//                            SessionEntity entity = task.getResult();
//                            if (entity != null) {
