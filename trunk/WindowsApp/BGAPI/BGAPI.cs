    ...
    public class BGAPI : BGAPITransportListener
    {
        ...
        public virtual void packetReceived(BGAPIPacket packet)
        {
            if (packet.MsgType == 0)
            {
                ...
                {
                    case 0:
                        receive_system_cmd(packet);
                        break;
                    case 1:
                        receive_flash_cmd(packet);
                        break;
                    case 2:
                        receive_attributes_cmd(packet);
                        break;
                    case 3:
                        receive_connection_cmd(packet);
                        break;
                    case 4:
                        receive_attclient_cmd(packet);
                        break;
                    case 5:
                        receive_sm_cmd(packet);
                        break;
                    case 6:
                        receive_gap_cmd(packet);
                        break;
                    case 7:
                        receive_hardware_cmd(packet);
                        break;
                    case 8:
                        receive_test_cmd(packet);
                        break;
                    default:
                        break;
                }
            ...
            else
            {
                ...
                {
                    case 0:
                        receive_system_evt(packet);
                        break;
                    case 1:
                        receive_flash_evt(packet);
                        break;
                    case 2:
                        receive_attributes_evt(packet);
                        break;
                    case 3:
                        receive_connection_evt(packet);
                        break;
                    case 4:
                        receive_attclient_evt(packet);
                        break;
                    case 5:
                        receive_sm_evt(packet);
                        break;
                    case 6:
                        receive_gap_evt(packet);
                        break;
                    case 7:
                        receive_hardware_evt(packet);
                        break;
                    case 8:
                        receive_test_evt(packet);
                        break;
                    default:
                        break;
                }
        ...
        private void receive_system_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_system_reset(packet);
                    break;
                case 1:
                    receive_system_hello(packet);
                    break;
                case 2:
                    receive_system_address_get(packet);
                    break;
                case 3:
                    receive_system_reg_write(packet);
                    break;
                case 4:
                    receive_system_reg_read(packet);
                    break;
                case 5:
                    receive_system_get_counters(packet);
                    break;
                case 6:
                    receive_system_get_connections(packet);
                    break;
                case 7:
                    receive_system_read_memory(packet);
                    break;
                case 8:
                    receive_system_get_info(packet);
                    break;
                case 9:
                    receive_system_endpoint_tx(packet);
                    break;
                case 10:
                    receive_system_whitelist_append(packet);
                    break;
                case 11:
                    receive_system_whitelist_remove(packet);
                    break;
                case 12:
                    receive_system_whitelist_clear(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_system_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_system_boot(packet);
                    break;
                case 1:
                    receive_system_debug(packet);
                    break;
                case 2:
                    receive_system_endpoint_rx(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_flash_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_flash_ps_defrag(packet);
                    break;
                case 1:
                    receive_flash_ps_dump(packet);
                    break;
                case 2:
                    receive_flash_ps_erase_all(packet);
                    break;
                case 3:
                    receive_flash_ps_save(packet);
                    break;
                case 4:
                    receive_flash_ps_load(packet);
                    break;
                case 5:
                    receive_flash_ps_erase(packet);
                    break;
                case 6:
                    receive_flash_erase_page(packet);
                    break;
                case 7:
                    receive_flash_write_words(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_attributes_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_attributes_write(packet);
                    break;
                case 1:
                    receive_attributes_read(packet);
                    break;
                case 2:
                    receive_attributes_read_type(packet);
                    break;
                case 3:
                    receive_attributes_user_response(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_attributes_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_attributes_value(packet);
                    break;
                case 1:
                    receive_attributes_user_request(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_connection_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_connection_disconnect(packet);
                    break;
                case 1:
                    receive_connection_get_rssi(packet);
                    break;
                case 2:
                    receive_connection_update(packet);
                    break;
                case 3:
                    receive_connection_version_update(packet);
                    break;
                case 4:
                    receive_connection_channel_map_get(packet);
                    break;
                case 5:
                    receive_connection_channel_map_set(packet);
                    break;
                case 6:
                    receive_connection_features_get(packet);
                    break;
                case 7:
                    receive_connection_get_status(packet);
                    break;
                case 8:
                    receive_connection_raw_tx(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_connection_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_connection_status(packet);
                    break;
                case 1:
                    receive_connection_version_ind(packet);
                    break;
                case 2:
                    receive_connection_feature_ind(packet);
                    break;
                case 3:
                    receive_connection_raw_rx(packet);
                    break;
                case 4:
                    receive_connection_disconnected(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_attclient_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_attclient_find_by_type_value(packet);
                    break;
                case 1:
                    receive_attclient_read_by_group_type(packet);
                    break;
                case 2:
                    receive_attclient_read_by_type(packet);
                    break;
                case 3:
                    receive_attclient_find_information(packet);
                    break;
                case 4:
                    receive_attclient_read_by_handle(packet);
                    break;
                case 5:
                    receive_attclient_attribute_write(packet);
                    break;
                case 6:
                    receive_attclient_write_command(packet);
                    break;
                case 7:
                    receive_attclient_reserved(packet);
                    break;
                case 8:
                    receive_attclient_read_long(packet);
                    break;
                case 9:
                    receive_attclient_prepare_write(packet);
                    break;
                case 10:
                    receive_attclient_execute_write(packet);
                    break;
                case 11:
                    receive_attclient_read_multiple(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_attclient_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_attclient_indicated(packet);
                    break;
                case 1:
                    receive_attclient_procedure_completed(packet);
                    break;
                case 2:
                    receive_attclient_group_found(packet);
                    break;
                case 3:
                    receive_attclient_attribute_found(packet);
                    break;
                case 4:
                    receive_attclient_find_information_found(packet);
                    break;
                case 5:
                    receive_attclient_attribute_value(packet);
                    break;
                case 6:
                    receive_attclient_read_multiple_response(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_sm_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_sm_encrypt_start(packet);
                    break;
                case 1:
                    receive_sm_set_bondable_mode(packet);
                    break;
                case 2:
                    receive_sm_delete_bonding(packet);
                    break;
                case 3:
                    receive_sm_set_parameters(packet);
                    break;
                case 4:
                    receive_sm_passkey_entry(packet);
                    break;
                case 5:
                    receive_sm_get_bonds(packet);
                    break;
                case 6:
                    receive_sm_set_oob_data(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_sm_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_sm_smp_data(packet);
                    break;
                case 1:
                    receive_sm_bonding_fail(packet);
                    break;
                case 2:
                    receive_sm_passkey_display(packet);
                    break;
                case 3:
                    receive_sm_passkey_request(packet);
                    break;
                case 4:
                    receive_sm_bond_status(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_gap_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_gap_set_privacy_flags(packet);
                    break;
                case 1:
                    receive_gap_set_mode(packet);
                    break;
                case 2:
                    receive_gap_discover(packet);
                    break;
                case 3:
                    receive_gap_connect_direct(packet);
                    break;
                case 4:
                    receive_gap_end_procedure(packet);
                    break;
                case 5:
                    receive_gap_connect_selective(packet);
                    break;
                case 6:
                    receive_gap_set_filtering(packet);
                    break;
                case 7:
                    receive_gap_set_scan_parameters(packet);
                    break;
                case 8:
                    receive_gap_set_adv_parameters(packet);
                    break;
                case 9:
                    receive_gap_set_adv_data(packet);
                    break;
                case 10:
                    receive_gap_set_directed_connectable_mode(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_gap_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_gap_scan_response(packet);
                    break;
                case 1:
                    receive_gap_mode_changed(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_hardware_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_hardware_io_port_config_irq(packet);
                    break;
                case 1:
                    receive_hardware_set_soft_timer(packet);
                    break;
                case 2:
                    receive_hardware_adc_read(packet);
                    break;
                case 3:
                    receive_hardware_io_port_config_direction(packet);
                    break;
                case 4:
                    receive_hardware_io_port_config_function(packet);
                    break;
                case 5:
                    receive_hardware_io_port_config_pull(packet);
                    break;
                case 6:
                    receive_hardware_io_port_write(packet);
                    break;
                case 7:
                    receive_hardware_io_port_read(packet);
                    break;
                case 8:
                    receive_hardware_spi_config(packet);
                    break;
                case 9:
                    receive_hardware_spi_transfer(packet);
                    break;
                case 10:
                    receive_hardware_i2c_read(packet);
                    break;
                case 11:
                    receive_hardware_i2c_write(packet);
                    break;
                case 12:
                    receive_hardware_set_txpower(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_hardware_evt(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_hardware_io_port_status(packet);
                    break;
                case 1:
                    receive_hardware_soft_timer(packet);
                    break;
                case 2:
                    receive_hardware_adc_result(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_test_cmd(BGAPIPacket packet)
        {
            ...
            {
                case 0:
                    receive_test_phy_tx(packet);
                    break;
                case 1:
                    receive_test_phy_rx(packet);
                    break;
                case 2:
                    receive_test_phy_end(packet);
                    break;
                case 3:
                    receive_test_phy_reset(packet);
                    break;
                case 4:
                    receive_test_get_channel_map(packet);
                    break;
                default:
                    break;
            }
        ...
        private void receive_system_endpoint_rx(BGAPIPacket __packet)
        {
            ...
            byte[] data = r.r_uint8array();
            foreach (BGAPIListener l in listeners)
                l.receive_system_endpoint_rx(endpoint, data);
        }
        ...
        private void receive_flash_ps_key(BGAPIPacket __packet)
        {
            ...
            byte[] value = r.r_uint8array();
            foreach (BGAPIListener l in listeners)
                l.receive_flash_ps_key(key, value);
        }
        ...
        private void receive_attributes_user_request(BGAPIPacket __packet)
        {
            ...
            int offset = r.r_uint16();
            foreach (BGAPIListener l in listeners)
                l.receive_attributes_user_request(connection, handle, offset);
        }
        ...
        private void receive_connection_disconnected(BGAPIPacket __packet)
        {
            ...
            foreach (BGAPIListener l in listeners)
                l.receive_connection_disconnected(connection, reason);
        }
        ...
        private void receive_attclient_read_multiple_response(BGAPIPacket __packet)
        {
            ...
            foreach (BGAPIListener l in listeners)
                l.receive_attclient_read_multiple_response(connection, handles);
        }
        ...
        private void receive_sm_bond_status(BGAPIPacket __packet)
        {
            ...
            int keys = r.r_uint8();
            foreach (BGAPIListener l in listeners)
                l.receive_sm_bond_status(bond, keysize, mitm, keys);
        }
        ...
        private void receive_gap_mode_changed(BGAPIPacket __packet)
        {
            ...
            foreach (BGAPIListener l in listeners)
                l.receive_gap_mode_changed(discover, connect);
        }
        ...
        private void receive_hardware_adc_result(BGAPIPacket __packet)
        {
            ...
            int value = r.r_int16();
            foreach (BGAPIListener l in listeners)
                l.receive_hardware_adc_result(input, value);
        }
        ...
        private void receive_test_get_channel_map(BGAPIPacket packet)
        {
            ...
            foreach (BGAPIListener l in listeners)
                l.receive_test_get_channel_map(channel_map);
        }
