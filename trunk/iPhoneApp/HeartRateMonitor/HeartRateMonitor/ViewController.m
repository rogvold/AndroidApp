...
@property (retain, nonatomic) NSMutableArray *heartRateMonitors;
@property (retain, nonatomic) IBOutlet UILabel *heartRateLabel;
@property (retain, nonatomic) IBOutlet UITableView *sensorsTable;
@property (retain, nonatomic) IBOutlet CBCentralManager *manager;
@property (retain, nonatomic) IBOutlet CBPeripheral *peripheral;
